...
const MOCK_DEVICES = [
  { id: 'NET-GW-01', name: 'Core Gateway', type: 'Server', isOn: true, isOnline: true, hasPassword: true, condition: 'Needs Maintenance', cyberState: 'Normal', lastMaintainedDate: '2024-06-12', authorizedRoles: ['IT Admin'], activeUsers: 5, dependencies: [], location: { city: 'Seattle', state: 'WA', country: 'USA', building: 'HQ', room: 'Server Room 1' }, openPorts: [80, 443, 22, 53], ipAddress: '10.0.0.1/16' },
  { id: 'HVAC-01', name: 'Main Air Handler', type: 'HVAC', isOn: true, isOnline: true, hasPassword: true, condition: 'Optimal', cyberState: 'Normal', lastMaintainedDate: '2026-01-15', authorizedRoles: ['Admin', 'Maintenance'], activeUsers: 1, dependencies: ['NET-GW-01', 'TEMP-SENS-12'], location: { city: 'Seattle', state: 'WA', country: 'USA', building: 'HQ', room: 'Roof Deck' }, openPorts: [502, 8080], ipAddress: '10.0.1.15/16' },
  { id: 'TEMP-SENS-12', name: 'Lobby Temperature', type: 'IoT Sensor', isOn: true, isOnline: false, hasPassword: false, condition: 'Degraded', cyberState: 'Warning', lastMaintainedDate: '2025-11-20', authorizedRoles: ['Admin'], activeUsers: 0, dependencies: ['NET-GW-01'], location: { city: 'Seattle', state: 'WA', country: 'USA', building: 'HQ', room: 'Main Lobby' }, openPorts: [], ipAddress: '10.0.2.112/16' },
  { id: 'AC-DOOR-05', name: 'Server Room Lock', type: 'Access Control', isOn: true, isOnline: true, hasPassword: true, condition: 'Optimal', cyberState: 'Compromised', lastMaintainedDate: '2026-03-01', authorizedRoles: ['Admin', 'Security'], activeUsers: 2, dependencies: ['CAM-09', 'NET-GW-01'], location: { city: 'Seattle', state: 'WA', country: 'USA', building: 'HQ', room: 'Server Room 1 Door' }, openPorts: [443, 1883], ipAddress: '10.0.3.50/16' },
  ...
  { id: 'ELEV-01', name: 'Main Elevator', type: 'Transport', isOn: true, isOnline: true, hasPassword: true, condition: 'Needs Maintenance', cyberState: 'Warning', lastMaintainedDate: '2025-08-30', authorizedRoles: ['Admin', 'Maintenance'], activeUsers: 0, dependencies: ['NET-GW-01'], location: { city: 'Seattle', state: 'WA', country: 'USA', building: 'HQ', room: 'Core Shaft' }, openPorts: [10001], ipAddress: '10.0.5.10/16' },
];
